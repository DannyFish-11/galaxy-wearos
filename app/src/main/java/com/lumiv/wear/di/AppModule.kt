 ...
 *
 * Usage: Initialize in LumivWearApplication.onCreate() via startKoin { modules(appModule) }
 */
...
val networkModule = module {
    ...
    // single<com.lumiv.wear.network.GatewayClient> { get<AIPClient>() }
}
