...
/**
 * LumivTileService — Wear OS Tile (glanceable widget)
 *
 ...
 */
class LumivTileService : androidx.wear.tiles.TileService() {
    ...
    companion object {
        ...
        fun requestRefresh(context: android.content.Context) {
            try {
                getUpdater(context).requestUpdate(LumivTileService::class.java)
            } catch (e: Exception) {
                android.util.Log.w("LumivTileService", "Tile refresh request failed: ${e.message}")
            }
        }
    }
